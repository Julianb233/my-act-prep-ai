      ...
      <div className="max-w-3xl space-y-6">
        ...
        <div className="bg-surface rounded-xl p-6 border border-border">
          ...
          <div className="flex items-center gap-6 mb-6">
            <div className="w-20 h-20 rounded-full bg-gradient-to-br from-teal-500 to-cyan-500 flex items-center justify-center text-3xl font-bold text-white">
              M
            </div>
            <div>
        ...
        <div className="bg-surface rounded-xl p-6 border border-border">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-foreground mb-2">ACT Test Date</label>
              <input
                type="date"
            ...
            <div>
              <label className="block text-sm font-medium text-foreground mb-2">Target Composite Score</label>
        ...
        <div className="bg-surface rounded-xl p-6 border border-border">
          ...
          <div className="space-y-4">
            {[
              { key: "email", label: "Email Notifications", description: "Score updates and study tips" },
              { key: "push", label: "Push Notifications", description: "Browser alerts for reminders" },
              { key: "reminders", label: "Study Reminders", description: "Daily practice reminders" },
              { key: "weekly", label: "Weekly Progress Reports", description: "Performance summaries" },
            ].map((item) => (
