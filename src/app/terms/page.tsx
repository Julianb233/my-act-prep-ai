          ...
          <div className="prose prose-lg max-w-none">
            <section className="mb-8">
              ...
              <p className="text-gray-600">
                By accessing or using My ACT Prep AI (&quot;the Service&quot;), you agree to be bound by these Terms of Service. If you do not agree to all terms and conditions, do not use the Service.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600">
                My ACT Prep AI provides AI-powered ACT preparation services including section-specific practice, full-length practice tests, score predictions, time management tools, and college matching features. Our Service is designed to supplement your ACT preparation efforts.
              </p>
            </section>
            ...
            <section className="mb-8" id="refund">
              ...
              <ul className="list-disc pl-6 text-gray-600 space-y-2">
                ...
                <li>Refund requests can be made by emailing support@myactprepai.com</li>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600">
                While our AI provides score predictions and college matching, we cannot guarantee specific score outcomes on the actual ACT exam. Score improvement depends on many factors including study time, effort, and individual circumstances. Our predictions are estimates based on your practice performance.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600">
                All content, features, and functionality of the Service are owned by My ACT Prep AI and protected by intellectual property laws. ACT is a registered trademark of ACT, Inc., which is not affiliated with our Service.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600">
                To the maximum extent permitted by law, My ACT Prep AI shall not be liable for any indirect, incidental, special, consequential, or punitive damages resulting from your use of the Service.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 mt-2">
                Email: <a href="mailto:legal@myactprepai.com" className="text-teal-600 hover:underline">legal@myactprepai.com</a>
              </p>
            </section>
          </div>
        </div>
