          ...
          <div className="prose prose-lg max-w-none">
            <section className="mb-8">
              ...
              <p className="text-gray-600">
                My ACT Prep AI (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;) is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our ACT preparation platform.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 text-gray-600 space-y-2">
                ...
                <li><strong>Practice Data:</strong> Question responses, section scores, composite scores, timing data</li>
                <li><strong>Usage Data:</strong> Features used, study time, device information</li>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 text-gray-600 space-y-2">
                <li>Provide personalized ACT preparation across all sections</li>
                <li>Analyze your performance and identify weak areas</li>
                <li>Generate score predictions and college matching</li>
                <li>Create customized study schedules and timing strategies</li>
                <li>Improve our AI models and educational content</li>
                <li>Send service updates and study reminders</li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 mt-2">
                Email: <a href="mailto:privacy@myactprepai.com" className="text-teal-600 hover:underline">privacy@myactprepai.com</a>
              </p>
            </section>
          </div>
        </div>
