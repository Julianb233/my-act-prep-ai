...
import { Trophy, Mail, Lock, User, ArrowRight, Check, Loader2 } from "lucide-react";
...
export default function SignupPage() {
  ...
  const benefits = [
    ...
    "College matching based on scores",
  ];
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-gradient-to-r from-teal-600 to-cyan-600 text-white py-3 rounded-xl font-semibold hover:opacity-90 transition flex items-center justify-center gap-2 disabled:opacity-50"
            >
              {isLoading ? (
