...
const navItems = [
  ...
  { href: "/dashboard/practice", icon: Target, label: "Section Practice" },
  { href: "/dashboard/tests", icon: FileText, label: "Full Practice Tests" },
  { href: "/dashboard/analysis", icon: BarChart3, label: "Score Analysis" },
  { href: "/dashboard/timing", icon: Clock, label: "Time Management" },
  { href: "/dashboard/colleges", icon: GraduationCap, label: "College Matching", comingSoon: true },
  { href: "/dashboard/writing", icon: PenTool, label: "Writing Practice", comingSoon: true },
];
    ...
    <aside className="fixed left-0 top-0 z-40 h-screen w-64 border-r border-border bg-surface/80 backdrop-blur-xl">
      <div className="flex h-full flex-col">
        ...
        <div className="flex h-16 items-center gap-2 border-b border-border px-6">
          ...
          <span className="text-lg font-bold text-foreground">My ACT Prep AI</span>
        </div>
        ...
        <div className="border-t border-border p-4">
          <div className="rounded-xl bg-gradient-to-br from-primary/20 to-secondary/20 p-4 backdrop-blur-sm">
            <p className="text-xs text-muted mb-1">Composite Score</p>
            <p className="text-2xl font-bold text-foreground">28</p>
            <p className="text-xs text-secondary">+4 from diagnostic</p>
          </div>
        </div>
      </div>
    </aside>
